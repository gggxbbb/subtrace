...
export type InviteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"token" | "creatorId" | "usedById" | "expiresAt" | "createdAt", ExtArgs["result"]["invite"]>
...
export interface InviteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const inviteWithTokenOnly = await prisma.invite.findMany({ select: { token: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Invites and only return the `token`
   * const inviteWithTokenOnly = await prisma.invite.createManyAndReturn({
   *   select: { token: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Invites and only return the `token`
   * const inviteWithTokenOnly = await prisma.invite.updateManyAndReturn({
   *   select: { token: true },
   *   where: {
   *     // ... provide filter here
   *   },
